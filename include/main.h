...
/**
 * Path to return to after game exit
 * Usually points to the ONSBrowser launcher
 */
extern char return_path[256];
 ...
 * Cleans up resources and returns to launcher
 *
 * @param flag Exit status (usually EXIT_SUCCESS or EXIT_FAILURE)
 */
